package com.ecospend.engagement.client;
...
/**
 * Sends badge/streak alerts through the notification-service (inbox + Expo
 * push). Best-effort: a notification failure must never break the
 * engagement engine, so errors are only logged.
 */
@Component
