...
/**
 * Sends contribution reminders through the notification-service (inbox +
 * Expo push). Best-effort: a notification failure must never break the
 * reminder sweep, so errors are only logged.
 */
@Component
